...
export function CustomerForm({ customer }: { customer?: CustomerDTO }) {
  ...
  return <form className="customer-form" action={formAction}>
    ...
    <label><span>Insurance Company <small>(optional)</small></span><select name="insuranceCompany" defaultValue={customer?.insuranceCompany ?? ""}><option value="">None</option><option value="Medibank">Medibank</option><option value="Bupa">Bupa</option><option value="HCF">HCF</option><option value="ARHG">ARHG</option></select></label>
